...
***Latest Version: 2.0.7 (Laravel 8.2.12)**
...
Developed by [@CelvinPrananta](https://github.com/CelvinPrananta/) since September 2019
...
protected function addUserInformation(&$payload)
{
    ...
    // ADDED FOR LARA-S-CMS BY Celvin Prananta - BEGIN
    if(\Session::has('admin')){
        $larascms_user = \Session::get('admin');
        $payload['user_id'] = $larascms_user->id;
    }
    // ADDED FOR LARA-S-CMS BY Celvin Prananta - END
...
If you discover a bug or security vulnerability within Lara-S-CMS, please send an email to Celvin Prananta at [kelvin.p2504@gmail.com](kelvin.p2504@gmail.com). All requests will be addressed promptly.
...
Lara-S-CMS is open-sourced software built by Celvin Prananta and contributors and licensed under the [MIT license](http://opensource.org/licenses/MIT).

## Credits

- Celvin Prananta (https://github.com/CelvinPrananta)
